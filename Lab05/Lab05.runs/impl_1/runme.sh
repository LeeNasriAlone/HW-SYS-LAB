...
HD_PWD='D:/Vivado/Workspace/Lab05/Lab05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nano_sc_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nano_sc_system.tcl -notrace
