...
HD_PWD='D:/Vivado/Workspace/LAB3/Problem2/Problem2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singlePulser.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singlePulser.tcl
