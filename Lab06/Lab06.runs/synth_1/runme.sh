...
HD_PWD='D:/Vivado/Workspace/Lab06/Lab06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartSystem.tcl
